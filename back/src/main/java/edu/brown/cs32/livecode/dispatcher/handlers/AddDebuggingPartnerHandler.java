...
public class AddDebuggingPartnerHandler implements Route {
  ...
  public AddDebuggingPartnerHandler(DebuggingPartnerQueue debuggingPartnerQueue, SessionState sessionState) {
  ...
  public Object handle(Request request, Response response) throws Exception {
    ...
    return new SuccessResponse(
        "success", "Debugging Partner " + name + " was added to the queue.")
        .serialize();
  }
}
